...
var content = $('<div class="timepicker">\
		<div v-show class="title">Pick a time</div>\
			<div class="chose-all">\
				...
				<div class="text">\
					<div class="cell-4"><a class="js-hour-show" title="Choose hour"></a></div>\
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="Choose minutes"></a></div>\
				</div>\
				<div class="handle">\
...
timepicker.bindEvent = function () {
	...
	// 
		...
		thisTimePicker.title.text('Pick a time');
	...
	thisTimePicker.hourShow.on('click',function() {
		...
		thisTimePicker.title.text('Choose hour');
	});
	...
	thisTimePicker.minuteShow.on('click',function() {
		...
		thisTimePicker.title.text('Choose minutes');
	});
};
