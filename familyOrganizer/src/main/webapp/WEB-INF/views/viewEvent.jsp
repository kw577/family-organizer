				...
				<div class="eventDetailViewBody">
					...
					<div class="eventDetailViewCard">
						<div class="eventDetailCardHeader">
							...
							<div class="eventDetailCardHeaderItem1">Wydarzenie nr 10</div>
						...
						<div class="eventDetailCardBody">
							...
							<div class="eventDetailCardBasic">
								<div class="eventDetailCardInfo">
									<span><i class="far fa-calendar fa-lg"
										title="Start date"></i></span>&#09; 20-08-2020 15:00
								</div>
								<div class="eventDetailCardInfo">
									<span><i class="far fa-calendar-check fa-lg"
										title="End date"></i></span>&#09; 22-08-2020 10:00
								</div>
								<div class="eventDetailCardInfo">
									<span><i class="fas fa-globe-europe fa-lg"
										title="Localization"></i></span>&#09; Gdynia
								</div>
							...
							<div class="eventDetailCardParticipants">
								...
								<div class="eventDetailCardParticipantsItem1">
									<span><i class="fas fa-users fa-lg" title="Participants"></i></span>&#09;Jan
									Nowak, Adam Nowak, Beata Nowak
								</div>
							...
							<div class="eventDetailCardDescription">
								<span style="font-weight: bold;">Description:</span></br> Opis
								wydarzenia nr 10. Opis wydarzenia nr 10. Opis wydarzenia nr 10.
								Opis wydarzenia nr 10. Opis wydarzenia nr 10. Opis wydarzenia nr
								10. Opis wydarzenia nr 10. Opis wydarzenia nr 10. Opis
								wydarzenia nr 10. Opis wydarzenia nr 10. Opis wydarzenia nr 10.
								Opis wydarzenia nr 10.
							</div>
										...
										<div class="chat_otherComments_cnt">
											...
											<div class="chat_otherComments_box">
												...
												<div class="chat_otherComments_body">
													dasfdfasadsfdfafddf fdfadsfsf</br> fasfdsfsdfdsf sdfsdafds sdfda
													fads fdfd dfsdaf adsf fddfasdfdsf saddsadsdSDs sdfasfdsf
													dfasfdfghgfhfhhfd
										...
										<div class="chat_otherComments_cnt">
											...
											<div class="chat_otherComments_box">
												...
												<div class="chat_otherComments_body">
													dasfdfasadsfdfafddf fdfadsfsf</br> fasfdsfsdfdsf sdfsdafds sdfda
													fads fdfd dfsdaf adsf fddfasdfdsf saddsadsdSDs sdfasfdsf
													dfasfdfghgfhfhhfd dfgfdgsdfg ffhfggh dfgs fasfdsfsdfdsf
													sdfsdafds sdfda fads fdfd dfsdaf adsf fddfasdfdsf
													saddsadsdSDs sdfasfdsf dfasfdfghgfhfhhfd dfgfdgsdfg ffhfggh
													dfgs fasfdsfsdfdsf sdfsdafds sdfda fads fdfd dfsdaf adsf
													fddfasdfdsf saddsadsdSDs sdfasfdsf dfasfdfghgfhfhhfd
													dfgfdgsdfg ffhfggh dfgs
								...
								<div class="chat_footer">
									<form>
										<div class="form-group">
											...
											maxlength="2500" placeholder="Enter your comment..."></textarea>
										</div>
